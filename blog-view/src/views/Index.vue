<template>
  <div class="index-container">
    ...
    <!-- 音乐播放器 -->
    <div>
      <meting-js server="netease" type="playlist" id="7367628930" fixed="true" mini="true" ></meting-js>
    </div>
...
.index-container {
  min-height: 100vh;
  background-image: url("https://cdn.jsdelivr.net/gh/LXY3028/photo/img/07 (37).jpg")!important; ;
