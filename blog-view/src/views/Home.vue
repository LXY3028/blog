  ...
  <div class="home-container">
    ...
    <el-card v-for="blog in blogs" :body-style="{padding: '0px'}" class="home-main-column-middle-card" :key="blog.id">
      <div class="home-title">
        ...
        <i style="font-size:15px" class="fa">&#xf073;</i> <span style="font-size: small;color: blue">{{ blog.createTime.split(' ')[0] }}  </span>
        <i class="fa fa-eye"></i><span style="font-size: small;color: blue"> {{ blog.views }}   </span>
